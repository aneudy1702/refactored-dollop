    ...
    <main className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-extrabold text-indigo-700 mb-4">SiteCompare</h1>
          <p className="text-xl text-gray-600">Visual side-by-side comparison tool for websites</p>
        </div>

        <div className="grid md:grid-cols-2 gap-8">
          {/* Quick Compare */}
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Quick Compare</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Element Inspector</h2>
              <p className="text-gray-500 mb-4 text-sm">
